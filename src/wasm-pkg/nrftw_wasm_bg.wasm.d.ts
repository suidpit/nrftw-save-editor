...
export const get_root_primitives: (a: number) => [number, number, number];
export const parse_save: (a: number, b: number, c: number, d: number) => [number, number, number];
export const patch_field: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => [number, number, number, number];
